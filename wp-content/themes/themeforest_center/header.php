...
<head>
    ...
    <meta name="description" content="Center is a responsive creative template">
    <meta name="keywords" content="portfolio, personal, corporate, business, parallax, creative, agency">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link href="<?php bloginfo('template_directory'); ?>/img/favicon.ico" rel="icon" type="image/png">
    ...
    <!-- YouTubePopUp CSS -->
    <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/YouTubePopUp.css">

    <!-- Font Icon Core CSS -->
    <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/et-line.css">
    ...
    <!--[if lt IE 9]-->
    <script src="<?php bloginfo('template_directory'); ?>/js/html5shiv.min.js" type="text/css"></script>
    <!--[endif]-->
    <?php wp_head();?>
</head>
<body>